...
From the repository root, compute stats from a workbook with:

```shell script
npm run stats:workbook -- /path/to/requirements.xlsx
```
...
You can then execute your native executable with: `./target/carpool-back-1.0-SNAPSHOT-runner`
